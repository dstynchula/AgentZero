...
from agentzero.web.jobs import UI_COLUMNS, list_jobs_for_ui
...
def create_app(
    *,
    ...
    def api_jobs(
        ...
        return list_jobs_for_ui(_db(request), include_rejected=include_rejected)
    ...
    def index(
        ...
        rows = list_jobs_for_ui(_db(request), include_rejected=show_rejected)
    ...
    def _redirect_index(show_rejected: bool) -> RedirectResponse:
        query = "?show_rejected=1" if show_rejected else ""
    ...
    def post_status_html(
        ...
        return _redirect_index(show_rejected)
