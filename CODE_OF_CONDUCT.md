...
reported to the maintainer privately through GitHub: open a private report via
the repository's **Security** tab ("Report a vulnerability") or send a direct
message to **@dstynchula** on GitHub. All complaints will be reviewed and
